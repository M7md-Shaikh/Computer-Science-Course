...
class Scientific extends Tawjihi {
	...
	public final ArrayList<String> subjects() {
		ArrayList<String> sub = new ArrayList<>(Arrays.asList("Arabic", "English", "Physics", "Math", "Biology",
	...
	public String toString() {
		return "Seating Number : " + super.getSeatingNum() + "Student Name : " + super.getName() + "Average : "
