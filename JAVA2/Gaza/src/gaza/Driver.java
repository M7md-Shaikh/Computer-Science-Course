	 ...
	 try {	
		...
		do {
		   ...
		   switch(choice) {
				...
				case 13 : 
					for (Family ffamily : manager.families) {
				        Family clonedFamily = ffamily.clone();
				        System.out.println("Original Family: " + ffamily);
				        System.out.println("Cloned Family: " + clonedFamily);
				        System.out.println("Reference Comparison: " + (family == clonedFamily));

				        // Print members of the cloned family
				        for (Person member : clonedFamily.getMembers()) {
				            System.out.println("Cloned Member: " + member);
				        }
				    }
				    break;
